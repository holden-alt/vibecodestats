  ...
  return (
    ...
    >
      ...
      <section style={sectionStyle}>
        <div style={labelStyle}>step 1 — install (works for any tool combo)</div>
        <p style={bodyStyle}>
          One command. macOS only. Installs the right trigger for your setup:
        </p>
        <ul style={{ ...bodyStyle, paddingLeft: 18, lineHeight: 1.7 }}>
          <li>
            <strong>Claude Code installed</strong> — adds a Stop hook so every CC
            turn pushes instantly.
          </li>
          <li>
            <strong>Codex CLI installed</strong> — also installs a launchd
            schedule that runs every 5 minutes, so heavy Codex sessions don&apos;t
            wait for a CC turn to update.
          </li>
          <li>
            <strong>Both installed</strong> — gets both. Instant on CC turns,
            5-minute safety net for Codex stretches. The script&apos;s 90s debounce
